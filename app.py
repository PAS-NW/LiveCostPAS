...
st.markdown(
    ...
    .pas-hero {{ display:flex; align-items:center; gap:16px; background: linear-gradient(100deg, #08090b 0%, #151718 70%, #c9aa00 130%) !important; border-radius: 16px !important; padding: 12px 22px !important; margin: 10px 0 18px 0 !important; box-shadow: 0 9px 25px rgba(0,0,0,.13) !important; min-height:60px; }}
...
with st.sidebar:
    ...
    st.markdown(
        ...
        <div class="pas-sidebar-rule"></div>
        <div class="pas-sidebar-footer">PAS NW Ltd • v1.10 Prototype Build</div>
        """,
        unsafe_allow_html=True,
    )
...
st.markdown(
    ...
    <div class="pas-hero">
      ...
      <div class="pas-hero-text">PAS Live Cost Dashboard<span class="pas-hero-dot">•</span><span class="pas-hero-version">v1.10 Prototype Build</span></div>
    </div>
    """,
    unsafe_allow_html=True,
)
